...
Figure~\ref{fig:postfitCR} shows the observed \ETg\ distributions in the four control regions compared with the results from simulations before and after performing the simultaneous fit across all the control samples and signal region, and assuming absence of any signal.
...
The observed distributions are in agreement with the prediction from SM and non-collision backgrounds.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[height=0.42\textheight]{Analysis/Figures/limits_vector.pdf}
  \includegraphics[height=0.42\textheight]{Analysis/Figures/limits_axial.pdf}
  \caption{
...
\begin{figure}[htbp]
  \centering
    \includegraphics[height=0.41\textheight]{Impact/Figures/limits_direct.pdf}
    \includegraphics[height=0.41\textheight]{Impact/Figures/limits_indirect.pdf}
    \caption{
