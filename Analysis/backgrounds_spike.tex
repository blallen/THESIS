...
\PH{I am not sure you can definitively conlclude this, but all it does is just put a bound. So the method is fine, but I think you should be more exacting on the language.}
