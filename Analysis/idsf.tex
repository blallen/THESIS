...
are predicted to be negligible from MC studies. \PH{I am confused,
  they are negligable yet you fit them. Also 1\% is of the same order as your quoted uncetainties}
...
are under kinematically exclusive selections. \PH{ even through? }
...
\PH{10\% of what? Also did you use the toys to validate gaussian pulls
with width 1?}
...
\end{table}
\PH{Maybe I misse this earlier, but I had to think for a sec why the
  MC is not 1. It might be good to explicitly explain there are two
  SFs e to $\gamma$ and Data to MC}
