...
The relative statistical uncertainty on the yields is at most 10\% for the fits in the high-\pt\ bins and decreases to the sub-percent level for the lowest \pt\ bins. %%% double check this number
