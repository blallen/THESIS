...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/sbcontam_near.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/sbcontam_nominal.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/sbcontam_far.pdf}
    }
  \caption{
...
\begin{figure}[htbp]
  ...
  \resizebox{0.95\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_175_medium_near_logy.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_400_medium_near_logy.pdf}
  }
  \resizebox{0.95\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_175_medium_nominal_logy.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_400_medium_nominal_logy.pdf}
  }
  \resizebox{0.95\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_175_medium_far_logy.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/ssfit_400_medium_far_logy.pdf}
  }
  \caption{
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/gjets_sieie.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/gjets_sieiePixelVeto.pdf}
  }
  \caption{
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{
    \includegraphics[]{Calibration/Figures/pvsf/efficiency_barrel_medium.pdf}
    \includegraphics[]{Calibration/Figures/pvsf/scalefactor_barrel_medium.pdf}
  }
  \caption{
