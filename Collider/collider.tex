...
temperature \PH{Too much required to achieve} required to achieve the desired magnetic field strength and cool sufficient amount of power out of the system.
...
in the observed final state. \PH{ This formalism, while abstract,
  doesn't seem correct. I think its better to write this in terms of
  an expansion of the fragmentation functions
  \sigma=fab\sigma+facDcb\sigma+fdcDdaDcb\sigma+....) take a look at
  https://hep.pa.msu.edu/resum/theory_overview.html or
  http://www.int.washington.edu/talks/WorkShops/int_10_3/People/Laenen_E/Laenen.pdf
  . Or more
  genericlly you can exponetiate D =>1+D+D2+...= e^D }
...
\PH{Its nice to see you discuss parton shower, but there are some
  things that you don't really explain, like why the infrared
  divergences are not an issue and how the origin of the sudakov
  appears. I would suggest adding this; it shouldn't take too much time}
