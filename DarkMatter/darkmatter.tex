...
\begin{equation}
  ...
  \Omega_\chi \cdot h^2 = \frac{m_\chi n_\chi}{\rho_c} \simeq \frac{10^{-27} \cm^{3}\text{ s}^{-1}}{\langle \sigma_A v \rangle},
\end{equation}
...
The latest Planck results measure that $\Omega_\chi \cdot h^2 = 0.1200 \pm 0.0012$, providing strong constaints on the possible values of $\sigma_A$ and $m_\chi$.
...
\begin{equation}
  \langle \sigma_A v \rangle \approx \left( \frac{\alpha \cdot g_\chi^2}{m_\chi} \right)^2 = \left( \frac{e^2}{4\pi} \cdot \frac{(0.8)^2}{100\GeV} \right)^2 \approx 10^{-26} \cm^{3}\text{ s}^{-1},
\end{equation}
...
Plugging this into Equation~\ref{eqn:relic_density}, we obtain $\Omega_\chi \cdot h^2 \approx 0.1$, which is very close to the observed value.
