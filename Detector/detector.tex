...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.875\textwidth]{Detector/Figures/cms_l1t.png}
  \caption{
...
The global trigger (GT) decides if an event should be sent to the HLT based on the information it receives from the GCT, the GMT, and the Timing, Trigger, and Control (TTC) system that monitors the readiness of the sub-detectors and the data acquisition (DAQ) system.
