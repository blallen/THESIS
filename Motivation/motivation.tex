...
\end{equation}
where $g_s$ is the strong interaction coupling strength with associated coupling constant $\alpha_s = \sfrac{g_s^2}{4\pi}$, $t_c$ are the eight $3\times3$ Hermitian traceless matrices that serve as the generators of the triplet representation of \suthree, and $G_c$ are the corresponding eight gluon fields.
