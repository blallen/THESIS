...
Given the value of an arbitrary coupling constant $\alpha$ at some known scale $q^2 = \mu^2$, the value of $\alpha$ at arbitrary scale is  
\begin{equation}
  \label{eqn:rge}
...
To one-loop order in QCD for values of $q^2$ and $\mu^2$ larger than the confinement scale \lqcd, the difference between the gluon self-energy corrections is given by 
\begin{equation}
  \label{eqn:beta_qcd}
