...
The five parameters used for the helical trajectory evolution are the curvature $\rho$, the azimuthal angle $\phi_0$, the impact parameter $d_0$ , the minimum distance along the beam axis $z_0$ , and $\lambda = \cot \theta$, where $\theta$ is the polar angle.
